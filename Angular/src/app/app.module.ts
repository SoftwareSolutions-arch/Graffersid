...
import {
  ...
  MatCardModule, MatPaginatorModule, MatTooltipModule,MatInputModule,MatDialogModule
...
@NgModule({
  ...
  imports: [
    ...
    MatButtonModule, MatDividerModule, MatFormFieldModule, MatIconModule,
    MatMenuModule, MatSelectModule, MatSidenavModule, MatTableModule, MatTabsModule,
    MatCardModule, MatPaginatorModule, MatTooltipModule,MatInputModule,MatDialogModule,MatSnackBarModule,
